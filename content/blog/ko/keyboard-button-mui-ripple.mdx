...
처음에는 <strong>"재사용성"</strong>을 위해 모든 것을 분리하려고 했으나, 실제로는

**단순한 기능**을 위해 **복잡한 구조**를 만들었고

**유지보수성**을 위해 **유지보수 부담**을 증가시켰다.
...
이렇게 사용할 때 필요한 건 **단순한 API**였다. 복잡한 hook이나 여러 파일이 필요하지 않았다.
